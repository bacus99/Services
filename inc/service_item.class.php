<?php
/*
 * @version $Id: HEADER 15930 2011-10-30 15:47:55Z Christian Bernard $
 -------------------------------------------------------------------------
...
/**
 * Class PluginServicesService_Item
 */
class PluginServicesService_Item extends CommonDBRelation {
   ...
   /**
    * @param PluginServicesService $item
    *
    * @return int
    */
   static function countForService(PluginServicesService $item) {
      ...
      return $dbu->countElementsInTable('glpi_plugin_services_services_items',
                                        ["itemtype" => $types,
                                         "plugin_services_services_id" => $item->getID()]);
   }
   ...
   /**
    * @param $plugin_services_services_id
    * @param $items_id
    * @param $itemtype
    *
    * @return bool
    */
   function getFromDBbyWebApplicationsAndItem($plugin_services_services_id,
                                              $items_id, $itemtype) {
      global $DB;
   ...
   function addItem($values) {
      ...
      $this->add(['plugin_services_services_id'
    ...
    * @since version 0.84
    *
    * @param PluginServicesService $service
    *
    * @return nothing
    * @internal param PluginServicesService $PluginServicesService object
    *
    */
      ...
      if ($canedit) {
         ...
         echo "<tr class='tab_bg_1'><td class='right'>";
         		         Dropdown::showSelectItemFromItemtypes(['items_id_name' => 'items_id',
                                                     ...
                                                     'itemtypes'     => PluginServicesService::getTypes(true),
                                                     'entity_restrict'
                                                                     => ($service->fields['is_recursive']
                                                        ? $dbu->getSonsOf('glpi_entities',
                                                                    $service->fields['entities_id'])
                                                                     : $service->fields['entities_id']),
                                                     'checkright'
                                                                     => true,
                                               ]);
   ...
   static function showForItem(CommonDBTM $item, $withtemplate = '') {
      ...
      $query .= $dbu->getEntitiesRestrictRequest(" AND", "glpi_plugin_services_services", '', '', true);
      ...
      if ($canedit && $withtemplate < 2) {
         ...
         $limit = $dbu->getEntitiesRestrictRequest(" AND ", "glpi_plugin_services_services", '', $entities, true);
         $q     = "SELECT COUNT(*)
         ...
         if (Session::haveRight("plugin_services", READ)
            ...
            PluginServicesService::dropdownService(['entity' => $entities,
                                                                              'used'   => $used]);
...
/*             echo "<td>".Dropdown::getDropdownName("glpi_plugin_services_serviceservertypes",
                 ...
                 "</td>"; */
            echo "<td>" . Dropdown::getDropdownName("glpi_plugin_services_servicetechnics",
                                                    $data["plugin_services_servicetechnics_id"]) .
                 "</td>";
   ...
   static function PdfFromItems(PluginPdfSimplePDF $pdf, CommonGLPI $item) {
      ...
      $query = "SELECT `glpi_plugin_services_services`.* "
         ...
         AND `glpi_plugin_services_services_items`.`plugin_services_services_id` = `glpi_plugin_services_services`.`id` "
               . $dbu->getEntitiesRestrictRequest(" AND ", "glpi_plugin_services_services", '', '', $web->maybeRecursive());
            ...
            if (Session::isMultiEntitiesMode()) {
               ...
               $pdf->displayLine($data["name"],
                                 Html::clean(Dropdown::getDropdownName("glpi_entities",
                                                                       $data['entities_id'])),
                                 Html::clean($dbu->getUserName("glpi_users", $data["users_id_tech"])),
